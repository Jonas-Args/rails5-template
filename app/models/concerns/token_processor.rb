module TokenProcessor
  ...
  def set_invite_token attributes={}
    self.invite_tokens.create(attributes.merge({token: generated_token}))
  end

  def set_forgot_token attributes={}
    self.forgot_tokens.create(attributes.merge({token: generated_token}))
  end
